 ...
 * Lee automáticamente todos los gráficos de /views/components/charts/
 */
...
class ChartRegistry {
    ...
    public static function load() {
        ...
        $charts_dir = __DIR__ . '/../../views/components/charts';
    ...
    /**
     * Obtener función de carga de configuración JavaScript
     */
    public static function getLoadConfigJS($id) {
        $chart = self::get($id);

        if (!$chart || !isset($chart['load_config_js'])) {
            return null;
        }

        return $chart['load_config_js'];
    }
}
