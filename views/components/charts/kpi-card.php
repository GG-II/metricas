...
/**
 * GRÁFICO: KPI Card
 * Tarjeta con valor destacado, ícono y comparación
 */
...
return [
    ...
    'meta' => [
        'id' => 'kpi_card',
        'nombre' => 'KPI Card',
        'descripcion' => 'Valor destacado con ícono',
        'icono' => 'square-number',
        'requiere_metricas' => 1,
        'version' => '1.0'
    ],
...
<div class="row g-3">
    ...
    <div class="col-md-12">
        <label class="form-check form-switch">
            <input type="checkbox" name="mostrar_comparacion" class="form-check-input" checked>
            <span class="form-check-label">Mostrar comparación con período anterior</span>
        </label>
    </div>
</div>
HTML;
    ...
    'process' => function($post) {
        return [
            ...
            'mostrar_comparacion' => isset($post['mostrar_comparacion'])
        ];
    },
...
function(form, config) {
    ...
    if (config.hasOwnProperty('mostrar_comparacion')) {
        const checkbox = form.querySelector('[name="mostrar_comparacion"]');
        if (checkbox) checkbox.checked = config.mostrar_comparacion;
    }
}
JS,
