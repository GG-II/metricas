<?php
/**
 * GRÁFICO: Stacked Area (Área Apilada)
 * Muestra áreas apiladas para visualizar composición total
 */
...
return [
    'meta' => [
        'id' => 'stacked_area',
        'nombre' => 'Área Apilada',
        'descripcion' => 'Visualiza composición de partes apiladas',
        'icono' => 'chart-area-line',
        'requiere_metricas' => 2,
        'version' => '1.0'
    ],
...
<div class="row g-3">
    <div class="col-12">
        <div class="card-hint" style="padding: 0.5rem; background-color: rgba(59, 130, 246, 0.1); border-left: 3px solid #3b82f6; border-radius: 4px; color: #3b82f6;">
            ...
            Ideal para ver cómo las partes conforman el total a lo largo del tiempo
        </div>
    </div>
