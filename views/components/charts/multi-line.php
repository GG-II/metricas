<?php
/**
 * GRÁFICO: Multi-Line (Líneas Múltiples)
 * Compara tendencias de 2-5 métricas en el mismo gráfico
 */

return [
    'meta' => [
        'id' => 'multi_line',
        'nombre' => 'Líneas Múltiples',
        'descripcion' => 'Compara tendencias de 2-5 métricas simultáneamente',
        'icono' => 'chart-line',
        'requiere_metricas' => 2,
        'version' => '1.0'
    ],
...
<div class="row g-3">
    <div class="col-12">
        <div class="card-hint" style="padding: 0.5rem; background-color: rgba(59, 130, 246, 0.1); border-left: 3px solid #3b82f6; border-radius: 4px; color: #3b82f6;">
            ...
            Perfecto para comparar evolución de múltiples métricas en el tiempo
        </div>
    </div>
    ...
    <div class="col-md-6 d-flex align-items-end">
        <label class="form-check mt-3">
            ...
            <span class="form-check-label">Curvas suaves</span>
        </label>
    </div>
</div>
HTML;
...
function(form, config) {
    ...
    const checkbox = form.querySelector('[name="suave"]');
    if (checkbox) checkbox.checked = config.suave;
}
JS,
